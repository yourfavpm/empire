                            ...
                            <div className="space-y-3">
                                ...
                                {subcategories.map(sub => (
                                    <div
                                        ...
                                        className={`p-5 rounded-2xl border-2 transition-all cursor-pointer group ${selectedSubcategoryId === sub.id ? 'bg-white border-brand shadow-xl ring-8 ring-brand/5' : 'bg-white border-slate-50 hover:border-slate-200'}`}
                                    >
                    ...
                    <Card className={`border-slate-200 bg-white shadow-sm overflow-hidden ${!selectedSubcategoryId ? 'opacity-40 grayscale pointer-events-none' : ''}`}>
                        ...
                        <CardContent className="p-2">
                            ...
                            <div className="max-h-[500px] overflow-y-auto space-y-3 p-2 custom-scrollbar">
                                ...
                                {units.map(unit => (
                                    <div key={unit.id} className={`p-4 rounded-xl border transition-all ${unit.status === 'SOLD' ? 'bg-slate-50/50 border-slate-50 opacity-60' : 'bg-white border-slate-100 shadow-sm hover:border-slate-200'}`}>
